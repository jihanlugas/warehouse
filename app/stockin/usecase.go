...
type Usecase interface {
	...
	Create(loginUser jwt.UserLogin, req request.CreateStockin) (vStockmovementvehicle model.StockmovementvehicleView, err error)
...
func (u usecase) Create(loginUser jwt.UserLogin, req request.CreateStockin) (vStockmovementvehicle model.StockmovementvehicleView, err error) {
	...
	if !vWarehouse.IsStockin {
		return vStockmovementvehicle, errors.New(fmt.Sprint("this warehouse is not allowed to create stockin"))
	}
