...
// Page
// @Tags StockmovementvehiclePurchaseorder
// @Security BearerAuth
// @Accept json
// @Produce json
// @Param req query request.PageStockmovementvehiclePurchaseorder false "url query string"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order [get]
func (h Handler) Page(c echo.Context) error {
	...
	req := new(request.PageStockmovementvehiclePurchaseorder)
...
// @Accept json
// @Produce json
// @Param req body request.CreateStockmovementvehiclePurchaseorder true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order [post]
func (h Handler) Create(c echo.Context) error {
	...
	req := new(request.CreateStockmovementvehiclePurchaseorder)
	if err = c.Bind(req); err != nil {
		return response.Error(http.StatusBadRequest, response.ErrorHandlerBind, err, nil).SendJSON(c)
	}
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			...
			Title:                  fmt.Sprintf("Buat Pengiriman Keluar Purchase Order"),
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Buat Pengiriman Keluar Purchase Order"),
		Description:            fmt.Sprintf("Buat Pengiriman Keluar Purchase Order %s", vStockmovementvehicle.Number),
		Request:                req,
		Response:               nil,
	})
...
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order/{id} [get]
...
// @Produce json
// @Param id path string true "ID"
// @Param req body request.UpdateStockmovementvehiclePurchaseorder true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order [post]
func (h Handler) Update(c echo.Context) error {
	...
	req := new(request.UpdateStockmovementvehiclePurchaseorder)
	if err = c.Bind(req); err != nil {
		return response.Error(http.StatusBadRequest, response.ErrorHandlerBind, err, nil).SendJSON(c)
	}
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Edit Loading Pengiriman Keluar Purchase Order"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                req,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Edit Loading Pengiriman Keluar Purchase Order"),
		Description:            fmt.Sprintf("Edit Loading Pengiriman Keluar Purchase Order %s", vStockmovementvehicle.Number),
		Request:                req,
		Response:               nil,
	})
...
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order/{id} [delete]
func (h Handler) Delete(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Hapus Pengiriman Keluar Purchase Order"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                nil,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Hapus Pengiriman Keluar Purchase Order"),
		Description:            fmt.Sprintf("Hapus Pengiriman Keluar Purchase Order %s", vStockmovementvehicle.Number),
		Request:                nil,
		Response:               nil,
	})
...
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order/{id}/set-complete [put]
func (h Handler) SetComplete(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Set In Transit Pengiriman Keluar Purchase Order"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                nil,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Set In Transit Pengiriman Keluar Purchase Order"),
		Description:            fmt.Sprintf("Set In Transit Pengiriman Keluar Purchase Order %s", vStockmovementvehicle.Number),
		Request:                nil,
		Response:               nil,
	})
...
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /stockmovementvehicle/purchase-order/{id}/generate-delivery-order [get]
func (h Handler) GenerateDeliveryOrder(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Generate Surat Jalan"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                nil,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Generate Surat Jalan"),
		Description:            fmt.Sprintf("Generate Surat Jalan %s", vStockmovementvehicle.Number),
		Request:                nil,
		Response:               nil,
	})
