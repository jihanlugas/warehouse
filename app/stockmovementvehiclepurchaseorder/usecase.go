...
type Usecase interface {
	...
	Create(loginUser jwt.UserLogin, req request.CreateStockmovementvehiclePurchaseorder) (err error)
	Update(loginUser jwt.UserLogin, id string, req request.UpdateStockmovementvehiclePurchaseorder) (err error)
...
func (u usecase) Create(loginUser jwt.UserLogin, req request.CreateStockmovementvehiclePurchaseorder) (err error) {
	...
	if !vWarehouse.IsPurchaseorder {
		return errors.New(fmt.Sprint("this warehouse is not allowed to create purchase order"))
	}
	...
	if vPurchhaseorder.PurchaseorderStatus != model.PurchaseorderStatusOpen {
		return errors.New(fmt.Sprintf("unable to create purchase order with status %s", strings.ToLower(string(vPurchhaseorder.PurchaseorderStatus))))
	}
...
func (u usecase) Update(loginUser jwt.UserLogin, id string, req request.UpdateStockmovementvehiclePurchaseorder) (err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
