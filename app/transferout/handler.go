...
func (h Handler) Create(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			...
			Title:                  fmt.Sprintf("Buat Pengiriman Keluar"),
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Buat Pengiriman Keluar"),
		Description:            fmt.Sprintf("Buat Pengiriman Keluar %s", vStockmovementvehicle.Number),
		Request:                req,
		Response:               nil,
	})
...
func (h Handler) Update(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Edit Loading Pengiriman Keluar"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                req,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Edit Loading Pengiriman Keluar"),
		Description:            fmt.Sprintf("Edit Loading Pengiriman Keluar %s", vStockmovementvehicle.Number),
		Request:                req,
		Response:               nil,
	})
...
func (h Handler) Delete(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Hapus Pengiriman Keluar"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                nil,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Hapus Pengiriman Keluar"),
		Description:            fmt.Sprintf("Hapus Pengiriman Keluar %s", vStockmovementvehicle.Number),
		Request:                nil,
		Response:               nil,
	})
...
func (h Handler) SetInTransit(c echo.Context) error {
	...
	vStockmovementvehicle, err := h.usecase.SetInTransit(loginUser, id)
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Set In Transit Pengiriman Keluar"),
			Description:            strings.TrimSpace(fmt.Sprintf("%s %s", vStockmovementvehicle.Number, err.Error())),
			Request:                nil,
			Response:               nil,
		})
	...
	go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeSuccess, request.CreateAuditlog{
		StockmovementvehicleID: vStockmovementvehicle.ID,
		Title:                  fmt.Sprintf("Set In Transit Pengiriman Keluar"),
		Description:            fmt.Sprintf("Set In Transit Pengiriman Keluar %s", vStockmovementvehicle.Number),
		Request:                nil,
		Response:               nil,
	})
