...
func (h Handler) Create(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			...
			Title:                  fmt.Sprintf("Buat Pengiriman Keluar %s", vStockmovementvehicle.Number),
...
func (h Handler) Update(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Edit Loading Pengiriman Keluar %s", vStockmovementvehicle.Number),
			Description:            err.Error(),
			Request:                req,
			Response:               nil,
		})
...
func (h Handler) Delete(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Hapus Pengiriman Keluar %s", vStockmovementvehicle.Number),
			Description:            err.Error(),
			Request:                nil,
			Response:               nil,
		})
...
func (h Handler) SetInTransit(c echo.Context) error {
	...
	if err != nil {
		go h.auditlogUsecase.CreateAuditlog(loginUser, model.AuditlogTypeFailed, request.CreateAuditlog{
			StockmovementvehicleID: vStockmovementvehicle.ID,
			Title:                  fmt.Sprintf("Set In Transit Pengiriman Keluar %s", vStockmovementvehicle.Number),
			Description:            err.Error(),
			Request:                nil,
			Response:               nil,
		})
