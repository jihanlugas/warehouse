...
type Usecase interface {
	...
	Create(loginUser jwt.UserLogin, req request.CreateTransferout) (err error)
	Update(loginUser jwt.UserLogin, id string, req request.UpdateTransferout) (err error)
	Delete(loginUser jwt.UserLogin, id string) (err error)
	SetInTransit(loginUser jwt.UserLogin, id string) (err error)
...
func (u usecase) Create(loginUser jwt.UserLogin, req request.CreateTransferout) (err error) {
	...
	if !vWarehouse.IsTransferOut {
		return errors.New(fmt.Sprint("this warehouse is not allowed to create transfer out"))
	}
...
func (u usecase) Update(loginUser jwt.UserLogin, id string, req request.UpdateTransferout) (err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
...
func (u usecase) SetInTransit(loginUser jwt.UserLogin, id string) (err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
