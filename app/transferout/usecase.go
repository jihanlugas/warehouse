...
type Usecase interface {
	Page(loginUser jwt.UserLogin, req request.PageTransferout) (vStockmovementvehicles []model.StockmovementvehicleView, count int64, err error)
	GetById(loginUser jwt.UserLogin, id string, preloads ...string) (vStockmovementvehicle model.StockmovementvehicleView, err error)
	Create(loginUser jwt.UserLogin, req request.CreateTransferout) (vStockmovementvehicle model.StockmovementvehicleView, err error)
	Update(loginUser jwt.UserLogin, id string, req request.UpdateTransferout) (vStockmovementvehicle model.StockmovementvehicleView, err error)
	Delete(loginUser jwt.UserLogin, id string) (vStockmovementvehicle model.StockmovementvehicleView, err error)
	SetInTransit(loginUser jwt.UserLogin, id string) (vStockmovementvehicle model.StockmovementvehicleView, err error)
...
func (u usecase) Page(loginUser jwt.UserLogin, req request.PageTransferout) (vStockmovementvehicles []model.StockmovementvehicleView, count int64, err error) {
...
func (u usecase) Create(loginUser jwt.UserLogin, req request.CreateTransferout) (vStockmovementvehicle model.StockmovementvehicleView, err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
	var vWarehouse model.WarehouseView
	var vToWarehouse model.WarehouseView
	...
	if !vWarehouse.IsTransferOut {
		return vStockmovementvehicle, errors.New(fmt.Sprint("this warehouse is not allowed to create transfer out"))
	}

	vToWarehouse, err = u.warehouseRepository.GetViewById(conn, req.ToWarehouseID)
	if err != nil {
		return vStockmovementvehicle, errors.New(fmt.Sprintf("failed to get %s: %v", u.warehouseRepository.Name(), err))
	}
	...
	tStockmovementvehicle = model.Stockmovementvehicle{
		...
		ToLocationID:               vToWarehouse.LocationID,
		FromWarehouseID:            vWarehouse.ID,
		ToWarehouseID:              vToWarehouse.ID,
		ProductID:                  req.ProductID,
...
func (u usecase) Update(loginUser jwt.UserLogin, id string, req request.UpdateTransferout) (vStockmovementvehicle model.StockmovementvehicleView, err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
...
func (u usecase) SetInTransit(loginUser jwt.UserLogin, id string) (vStockmovementvehicle model.StockmovementvehicleView, err error) {
	var tStockmovementvehicle model.Stockmovementvehicle
	...
	tStockmovementvehicle.StockmovementvehicleStatus = model.StockmovementvehicleStatusInTransit
	err = u.stockmovementvehicleRepository.Save(tx, tStockmovementvehicle)
	if err != nil {
		return vStockmovementvehicle, errors.New(fmt.Sprintf("failed to save %s: %v", u.stockmovementvehicleRepository.Name(), err))
	}
...
func NewUsecase(stockmovementvehicleRepository stockmovementvehicle.Repository, warehouseRepository warehouse.Repository, stockRepository stock.Repository, stocklogRepository stocklog.Repository, vehicleRepository vehicle.Repository) Usecase {
	return &usecase{
