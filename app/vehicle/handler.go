...
// @Accept json
// @Produce json
// @Param req query request.PageVehicle false "url query string"
...
func (h Handler) GetById(c echo.Context) error {
	...
	vVehicle, err := h.usecase.GetById(loginUser, id, preloadSlice...)
	if err != nil {
		return response.Error(http.StatusBadRequest, err.Error(), err, nil).SendJSON(c)
	}

	return response.Success(http.StatusOK, response.SuccessHandler, vVehicle).SendJSON(c)
}
...
// @Accept json
// @Produce json
// @Param req body request.CreateVehicle true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
// @Router /vehicle [post]
...
// @Produce json
// @Param id path string true "ID"
// @Param req body request.UpdateVehicle true "json req body"
// @Success      200  {object}	response.Response
// @Failure      500  {object}  response.Response
