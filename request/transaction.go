...
type CreateTransaction struct {
	...
	TransactionRelated string  `json:"transactionRelated" form:"transactionRelated" query:"transactionRelated" validate:"required"`
...
type PageTransaction struct {
	...
	TransactionRelated string     `json:"transactionRelated" form:"transactionRelated" query:"transactionRelated"`
